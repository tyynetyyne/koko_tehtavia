...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname heiluri-animaatio_valmis) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
(require 2htdp/image)
